...
const AddSim = () => {
  ...
  const handleSubmit = (e) => {
    ...
    return (
           ...
           <div class="dash">
                    <form onSubmit={handleSubmit} >
                     <div className="form-group">
                         <label class="form-control" htmlFor="username">Shop Name</label>
                        
            <select name='username' class="form-control" aria-label="username" required onChange={handleChange}>
            ...
            <label class="form-control" htmlFor="Operator">Operator</label>  <select name='Operator' class="form-control" aria-label="Operator"  required onChange={handleChange}>
          ...
          <div className="form-group">
            <label class="form-control" htmlFor="orderedAt">Ordered At</label>
