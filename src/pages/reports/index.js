...
const Reports = () => {
    ...
    return (
        ...
        <tbody>
                    {isLoding ? <div className='loading' ><ReactLoading className='loading' type='bubbles' color='#2C3E50' height={60} width={60}/></div> : users.map(used =>
                        <Reportrow key={used.id} used={used} /> 
                )}
         </tbody>
      </table>
        </div>
